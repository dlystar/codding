    ...
    export default{
        ...
        data(){
            return{
                ...
                header: [
                    ...
                    {title: '获取积分',key: 'points',},
                    {title: '获取信息',key: 'description',},
        ...
        methods:{
            findByPage(){
                let url = ''
                if(this.isAdmin){
                    url = '/adminRecordQuery/findGetPointsByPage'
                }else{
                    url = '/regionsCountiesRecordQuery/findGetPointsByPage'
                }
                this.axios.request({
                    params: this.params,
                    url,
