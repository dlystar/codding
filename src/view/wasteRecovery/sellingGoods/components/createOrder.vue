<template>
    ...
    <div class="regionsCountiesCategoryDetail">
        <div class="temp">
            <div class="categoryName" v-show="false"></div>
            <div class="content">
                <div class="detailName">&nbsp;</div>
                <div class="unitPrice">
                    <div class="width100" style="width: 140px;">重量/个数/其他</div>
                    <div class="width100" style="width: 100px;">单价</div>
                </div>
                <div style="width: 100px; text-align: center; margin-left:40px;">金额</div>
            </div>
        </div>
        <div class="temp" v-for="(item,index) in tableData" :key="index">
            ...
            <div class="content">
                ...
                <div class="unitPrice">
                    <div class="width100">
                        <InputNumber
                            ...
                            v-model="item.numericalValue" 
                            :placeholder="unitClasses[Number(item.unitClass)]"
                ...
                <div style="margin-left:20px;">
                    共：<Input v-model="item.money" style="width: 100px;" placeholder="请输入金额"/>
                </div>
            </div>
        </div>
    </div>
