<template>
    <!-- 区县代理管理员 -->
    <div class="adminRegionsCounties">
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            update(){
                let url = this.detailTitle == '新增' ? '/adminRegionsCounties/add' : '/adminRegionsCounties/update'
