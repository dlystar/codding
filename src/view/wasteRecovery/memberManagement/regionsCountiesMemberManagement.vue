<template>
    <!-- 会员列表（区县级代理） -->
    <div class="regionsCountiesMemberManagement">
...
<script>
    import detail from './components/memberDetaiFor.vue'
    ...
    export default{
        ...
        methods:{
            ...
            update(){
                let url = this.detailTitle == '新增' ? '/regionsCountiesMemberManagement/add' : '/regionsCountiesMemberManagement/update'
