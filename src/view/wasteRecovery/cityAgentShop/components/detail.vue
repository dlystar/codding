<template>
    <div class="baseInfo">
        <Form :model="detail" ref="detail" :rules="rules" :label-width="120">
            ...
            <FormItem label="区县代理人：" prop="regionsAndCountiesName">
                <Input v-model="detail.regionsAndCountiesName" :disabled="onlyAdd" readonly>
            ...
            <FormItem label="店铺省市区县：" prop="cityData">
                ...
                <!-- <Cascader 
                    v-model="detail.cityData" 
                    :data="cityData" filterable 
    ...
    export default {
        ...
        methods: {
            ...
            selectRegionsCounties() {
                ...
                this.detail.regionsAndCountiesName = this.$refs.selectRegionsCounties.currentData.userName
