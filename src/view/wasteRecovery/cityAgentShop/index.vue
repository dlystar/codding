    ...
    <div class="cityAgentShop">
        <div class="searchArea">
            ...
            <Row type="flex" align="middle" class="code-row-bg">
                ...
                <Col span="4">
                    <Input v-model="params.regionsCountiesName" style="width: 98%;" readonly clearable @on-clear="clearSelectRegionsCounties">
...
<script>
    ...
    export default{
        ...
        methods:{
            ...
            update(){
                let url = this.detailTitle == '新增' ? '/cityAgentShop/add' : '/cityAgentShop/update'
