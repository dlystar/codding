<template>
    <!-- 门店管理（区县级代理） -->
    <div class="regionsCountiesAgentShop">
        <div class="searchArea">
            ...
            <Row type="flex" align="middle" class="code-row-bg">
                ...
                <Col span="2">区县所属人：</Col>
                <Col span="4">
                    <Input v-model="params.regionsCountiesId" style="width: 98%;" readonly clearable>
                        <Icon type="md-apps" slot="suffix" @click="showSelectRegionsCounties" />
                    </Input>
                </Col>
                <Col span="2">创建日期：</Col>
                <Col span="4">
...
<script>
    ...
    export default{
        name: 'regionsCountiesAgentShop',
        components: {detail,selectRegionsCounties},
        mixins: [mixins],
        data(){
            return{
        ...
        methods:{
            findByPage(){
                this.axios.request({
                    ...
                    this.tableData.rows = []
                    this.tableData.rows.push(res.data.rows)
                    this.tableData.records = 1
            ...
            update(){
                let url = this.detailTitle == '新增' ? '/cityAgentShop/add' : '/cityAgentShop/updateMyShop'
            ...
            selectCityAgent(){
                this.cityAgentId = this.$refs.selectCityAgent.currentData.id
            },
        },
        created(){
            this.findByPage()
